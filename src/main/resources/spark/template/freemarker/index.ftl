...
<div class="container">
  ...
  <div class="row">
   ...
   <div class="alert alert-info text-center" role="alert">
    dasdadPlease do work through the Getting Started guide, even if you do know how to build such an application.  The guide covers the basics of working with Heroku, and will familiarize you with all the concepts you need in order to build and deploy your own apps.
  </div>
</div> <!-- row -->
